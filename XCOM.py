...
with DAG(
    ...
    # Pull accuracy from XCom: This allows you to push 
    #the accuracy value as an XCom in the machine_learning_task and then pull it in the downstream tasks,
    #such as task_mysql and task_bash
